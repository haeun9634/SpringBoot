...
public class QUserPrefer extends EntityPathBase<UserPrefer> {
    ...
    public final umc.spring.domain.QPreferenceFood preferenceFood;
    ...
    public QUserPrefer(Class<? extends UserPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.preferenceFood = inits.isInitialized("preferenceFood") ? new umc.spring.domain.QPreferenceFood(forProperty("preferenceFood")) : null;
